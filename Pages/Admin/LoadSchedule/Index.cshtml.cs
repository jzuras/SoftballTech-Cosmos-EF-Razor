...
public class LoadScheduleModel : Sbt.Pages.Admin.AdminPageModel
{
    ...
    public LoadScheduleModel(DemoContext context) : base(context)
    {
    }
    ...
    public async Task<IActionResult> OnPostAsync(string organization)
    {
        ...
        var loadResult = await this._context.LoadScheduleFileAsync(
            this.ScheduleFile, organization, this.DivisionID, this.UsesDoubleHeaders);
